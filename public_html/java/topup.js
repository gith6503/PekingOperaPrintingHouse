document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (event) {
        ...
        alert('Payment details submitted successfully! If you top up by cash, please come to my (Rachel Ng) house as stated in the location on the homepage when you are available and transfer your payment to me (Rachel Ng)! Your amount balance will be updated once your payment is submitted!');
    });
});
